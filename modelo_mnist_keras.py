...
Original file is located at
    https://colab.research.google.com/drive/1k85ky0LLW1V_rI62BRzNWibjjnAHOVVv
"""
...
import shap
# --- CONFIGURACIÓN ---
DATOS_ENTRENAMIENTO = 1000 # Prueba con 500, 5000 y 50000
...
ax1.bar(x, df['F'], bottom=df['A'], color='#e74c3c',
label='Errores')
ax1.bar(x, df['D'], bottom=df['A']+df['F'],
color='#dfe6e9', label='Duda (Humano)')
ax2 = ax1.twinx()
ax2.plot(x, df['P'], color='#2980b9', marker='o',
label='Calidad IA')
11
ax1.set_xticks(x)
